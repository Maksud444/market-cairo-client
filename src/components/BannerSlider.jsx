...
export default function BannerSlider() {
  ...
  const content = (isMobile) => (
    <div className={`relative z-10 h-full flex items-center transition-all duration-300 ${isAnimating ? 'opacity-0 scale-[0.99]' : 'opacity-100 scale-100'} ${isMobile ? 'px-8' : 'px-12'}`}>
