...
export default function RamadanBanner() {
  ...
  const stats = [
    { icon: FiZap, label: t('promo.feature_1'), color: 'text-yellow-300' },
    { icon: FiTag, label: t('promo.feature_2'), color: 'text-green-300' },
    { icon: FiShield, label: t('promo.feature_3'), color: 'text-blue-300' },
  ];
        ...
        >
          ...
          <div className="relative z-10 flex items-center px-4 py-3 gap-4">
            <div className="flex-1 min-w-0">
              <div className="text-white font-bold text-sm">{t('promo.sell_anything_title')}</div>
              <div className="text-white/60 text-xs mt-0.5">{t('promo.sell_anything_subtitle')}</div>
            </div>
        ...
        >
          ...
          <div className="relative z-10 h-full flex items-center px-8 gap-10">
            <div className="flex-shrink-0">
              <div className="text-white font-bold text-lg leading-tight">{t('promo.sell_anything_title')}</div>
              <div className="text-white/50 text-sm mt-0.5">{t('promo.sell_anything_subtitle')}</div>
            </div>
            ...
            <div className="flex items-center gap-8 flex-1">
              {stats.map(({ icon: Icon, color }, i) => (
                <div key={i} className="flex items-center gap-2.5">
                  ...
                  <span className="text-white/80 text-sm font-medium">{t(`promo.feature_${i + 1}`)}</span>
                </div>
              ))}
            </div>
