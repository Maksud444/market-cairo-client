...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: <FacebookIcon />, href: 'https://www.facebook.com/mysouqify', label: 'Facebook' },
    { icon: <InstagramIcon />, href: 'https://www.instagram.com/mysouqify', label: 'Instagram' },
    { icon: <TikTokIcon />, href: 'https://www.tiktok.com/@mysouqify', label: 'TikTok' },
    { icon: <WhatsAppIcon />, href: 'https://wa.me/message/mysouqify', label: 'WhatsApp' },
  ];
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full bg-gray-800 hover:bg-primary-600 flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                >
                  {s.icon}
                </a>
              ))}
